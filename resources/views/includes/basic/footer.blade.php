<footer class="bg-[#1B4071] shadow-md">
    <div class="container mx-auto px-4 py-8">
        <div class="text-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Brand Identity -->
            ...
            <div class="text-center md:text-left">
                ...
                <div class="flex justify-center md:justify-start space-x-6">
                    <a href="{{config('opticore.social_links.facebook')}}" target="_blank" aria-label="Facebook" class="hover:text-blue-600 transition-colors duration-300">
                    ...
                    <a href="{{config('opticore.social_links.x')}}" target="_blank" aria-label="x" class="hover:text-black transition-colors duration-300">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M 2.3671875 3 L 9.4628906 13.140625 L 2.7402344 21 L 5.3808594 21 L 10.644531 14.830078 L 14.960938 21 L 21.871094 21 L 14.449219 10.375 L 20.740234 3 L 18.140625 3 L 13.271484 8.6875 L 9.2988281 3 L 2.3671875 3 z M 6.2070312 5 L 8.2558594 5 L 18.033203 19 L 16.001953 19 L 6.2070312 5 z"/></svg>
                    </a>
                    <a href="{{config('opticore.social_links.instagram')}}" target="_blank" aria-label="Instagram" class="hover:text-pink-600 transition-colors duration-300">
                    ...
                    <a href="{{config('opticore.social_links.behance')}}" target="_blank" aria-label="Behance" class="hover:text-black transition-colors duration-300">
                    ...
                    <a href="{{config('opticore.social_links.pinterest')}}" target="_blank" aria-label="Pinterest" class="hover:text-[#E60023] transition-colors duration-300">
                    ...
                    <a href="{{config('opticore.social_links.linkedin')}}" target="_blank" aria-label="LinkedIn" class="hover:text-blue-700 transition-colors duration-300">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                    </a>
                    <a href="{{config('opticore.social_links.youtube')}}" target="_blank" aria-label="YouTube" class="hover:text-red-600 transition-colors duration-300">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    </a>
                    <a href="{{config('opticore.social_links.tiktok')}}" target="_blank" aria-label="TikTok" class="hover:text-black transition-colors duration-300">
        ...
        <div class="mt-8 pt-8 border-t border-gray-200">
            <p class="text-center text-white text-sm">
                {{config('opticore.brand_name_absolute')}} © 2025. All rights reserved.
            </p>
        </div>
    </div>
</footer>

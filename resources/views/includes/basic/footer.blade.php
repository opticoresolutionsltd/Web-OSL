    ...
    <div class="container mx-auto px-4 py-8">
        <div class="text-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="flex flex-col items-center md:items-start">
                <div class="flex items-center mb-4">
                    ...
                    <h2 class="text-xl font-bold ml-3">Opticore Solutions Ltd.</h2>
                </div>
            ...
            <div class="text-center md:text-left">
                ...
                <div class="flex justify-center md:justify-start space-x-6">
                    ...
                    <a href="#" aria-label="Twitter" class="hover:text-black transition-colors duration-300">
                    ...
                    <a href="#" aria-label="Instagram" class="hover:text-pink-600 transition-colors duration-300">
                    ...
                    <a href="#" aria-label="Behance" class="hover:text-black transition-colors duration-300">
                    ...
                    <a href="#" aria-label="Pinterest" class="hover:text-[#E60023] transition-colors duration-300">
        ...
        <div class="mt-8 pt-8 border-t border-gray-200">
            <p class="text-center text-white text-sm">
                Opticore Solutions Limited © 2025. All rights reserved.
            </p>
        </div>
    </div>
</footer>

<section class="bg-white h-screen">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-12 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
            ...
            <p class="mb-4 text-xl font-light text-gray-900">We apologize for the inconvenience and appreciate your patience as we work to get things back on track. In the meantime, you can either:

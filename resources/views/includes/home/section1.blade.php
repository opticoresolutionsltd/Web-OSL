<div id="controls-carousel" class="relative w-full pt-[72px]" data-carousel="slide" data-carousel-interval="5000">
    <!-- Carousel wrapper -->
    <div class="relative h-72 overflow-hidden md:h-[20rem] lg:h-[90svh]">
        ...
        <x-carousel.itemType01 data-carousel-item="active" bg-color="bg-[#EEE7F7]">
            ...
            <x-slot name="image">
                <x-images.image src="{{Vite::asset('resources/images/carousel/graphic-design.gif')}}" alt="Graphic Design" class="scale-125 xl:scale-150"/>
            </x-slot>
        ...
        <x-carousel.itemType02 bg-color="bg-[#E4E9F1]">
            ...
            <x-slot name="image">
                <x-images.image src="{{Vite::asset('resources/images/carousel/video-editing.gif')}}" alt="Video Editing" class="scale-150"/>
            </x-slot>
        ...
        <x-carousel.itemType02 bg-color="bg-[#E1EBEF]">
            ...
            <x-slot name="image">
                <x-images.image src="{{Vite::asset('resources/images/carousel/website-development.gif')}}" alt="Web Development" class="scale-150"/>
            </x-slot>
        </x-carousel.itemType02>
        <!-- Item 5 -->
        <x-carousel.itemType01 bg-color="bg-[#E3E5E1]">
            ...
            <x-slot name="image">
                <x-images.image src="{{Vite::asset('resources/images/carousel/3d-editing.gif')}}" alt="3D Production" class="scale-150"/>
            </x-slot>
        </x-carousel.itemType01>
    </div>
    <!-- Slider controls -->

@extends('layouts.app')
@section('title')
    <x-titles.title>Packaging Design Portfolio - {{config('opticore.brand_name_absolute')}}</x-titles.title>
@endsection
@section('meta-tags')
    ...
    <meta property="og:title" content="Packaging Design Portfolio - {{config('opticore.brand_name')}}">
    ...
    <meta name="twitter:title" content="Packaging Design Portfolio - {{config('opticore.brand_name')}}">
...
@section('container')
    ...
    @include('includes.portfolio.graphic design.packaging-design')

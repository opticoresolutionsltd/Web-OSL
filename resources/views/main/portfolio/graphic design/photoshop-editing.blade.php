@extends('layouts.app')
@section('title')
    <x-titles.title>Photoshop Editing Portfolio - {{config('opticore.brand_name_absolute')}}</x-titles.title>
@endsection
@section('meta-tags')
    ...
    <meta property="og:title" content="Photoshop Editing Portfolio - {{config('opticore.brand_name')}}">
    ...
    <meta name="twitter:title" content="Photoshop Editing Portfolio - {{config('opticore.brand_name')}}">
...
@section('container')
    ...
    @include('includes.portfolio.graphic design.photoshop-editing')

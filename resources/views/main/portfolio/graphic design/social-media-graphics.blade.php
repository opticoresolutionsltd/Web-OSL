@extends('layouts.app')
@section('title')
    <x-titles.title>Social Media Graphics Portfolio - {{config('opticore.brand_name_absolute')}}</x-titles.title>
@endsection
@section('meta-tags')
    ...
    <meta property="og:title" content="Social Media Graphics Portfolio - {{config('opticore.brand_name')}}">
    ...
    <meta name="twitter:title" content="Social Media Graphics Portfolio - {{config('opticore.brand_name')}}">
...
@section('container')
    ...
    @include('includes.portfolio.graphic design.social-media-graphics')

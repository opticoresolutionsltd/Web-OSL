<div class="flex flex-col sm:flex-row justify-center items-center my-8 sm:px-4 md:px-8 lg:px-12 xl:px-28 2xl:px-36">
    ...
    <div class="p-4 animate-fade-in-from-right">
